  ...
  return (
    <main className="min-h-screen bg-[#FFF5F7] text-[#2A0E12]">
      ...
      <section className="px-6 py-20 text-center">
        <span className="inline-block rounded-full bg-[#FFE3EC] px-4 py-2 text-sm font-medium text-[#FF2E88] shadow-sm transition duration-300 hover:scale-105">
        ...
        <div className="mx-auto mt-6 inline-flex items-center rounded-full bg-white px-5 py-3 shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-8 rounded-2xl bg-[#C00000] px-8 py-3 font-semibold text-white shadow-lg transition duration-300 hover:scale-105 hover:bg-[#A00000]"
        >
          Join the Waitlist ✨
        </a>
      </section>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-5xl rounded-2xl bg-white p-8 text-center shadow-lg transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <section className="px-6 py-20">
        <div className="mx-auto grid max-w-6xl items-center gap-10 rounded-2xl bg-white p-8 shadow-lg transition duration-300 hover:shadow-xl md:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl shadow-md transition duration-300 hover:scale-[1.02]">
            <img
              src="/founder.jpg"
              alt="Founder"
          ...
          <div>
            ...
            <p className="mt-4 font-semibold text-[#C00000]">
              Travel safe. Connect deeply. Feel renewed.
            </p>
          </div>
